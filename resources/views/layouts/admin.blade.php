...
<html>
  <head>
    ...
    <title>GestionAlmacenProductos</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="{{url('almacen/articulo')}}" class="logo">
          ...
          <span class="logo-mini"><b>GAP</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>GAP PANEL</b></span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <span class="hidden-xs">Panel Usuario</span>
                </a>
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Gestión de almacen y productos | GAP </h3>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2022 <a href="https://copyright.es/aspecto-juridico.html">GAP</a>.</strong> Todos los derechos reservados.
      </footer>
