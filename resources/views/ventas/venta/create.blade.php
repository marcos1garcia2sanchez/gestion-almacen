...
@section ('contenido')
  <div class="row">
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
      ...
      {!!Form::Open(array('url'=>'ventas/venta','method'=>'POST','autocomplete'=>'off'))!!}
            ...
            <div class="col-lg-4 col-md-4 col-sm-4  col-xs-12">
                ...
                <input type="text" name="num_comprobante" required value="{{old('num_comprobante')}}" class="form-control" placeholder=" Número del comprobante...">
            </div>
            </div>
            </div>
            ...
            <div class="panel-body">
                ...
                id="pstock" class="form-control" placeholder=" Stock...">
                ...
                <thead style="background-color:#C05C47">
                    <th>Opciones</th>
                    <th>Artículos</th>
                    <th>Cantidad</th>
                    <th>Precio Venta</th>
   ...
   $("#detalles").append(fila);
    ...
    {
      alert("La cantidad de la venta supera al stock")
    }

  }
  else
  {
   alert("Error al ingresar los detalles del ingreso, por favor revísalos");
  }
 }
